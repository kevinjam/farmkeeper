 ...
 * Uses a different approach to avoid removeChild errors
 */
export default function GoogleSignInSimple({ 
  ...
  const loadGoogleScript = () => {
    ...
    // Create and load script with proper attributes
    const script = document.createElement('script');
    script.src = 'https://accounts.google.com/gsi/client';
    script.async = true;
    script.defer = true;
    script.crossOrigin = 'anonymous';
    script.integrity = ''; // Remove integrity check that might cause issues
    script.referrerPolicy = 'strict-origin-when-cross-origin';
    
    script.onload = initializeGoogleSignIn;
    script.onerror = (event) => {
      console.error('Google script load error:', event);
    ...
    try {
      ...
      console.error('Error appending Google script:', error);
      setError('Failed to load Google authentication script');
    }
  };
